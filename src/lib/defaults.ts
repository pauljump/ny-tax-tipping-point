...
export const PARAM_METADATA: ParamMeta[] = [
  ...
  },
  {
    ...
    source: {
      ...
      year: 2016,
      isAssumption: true,
      notes: 'Young & Varner: 0.1-0.4 (NJ millionaires). Rauh & Shyu: 0.8 (CA top bracket, but migration = only 9.5% of behavioral response). Moretti & Wilson: 1.6-2.3 (star scientists, upper bound for mobile talent). Default 0.5 is a central migration-only estimate.',
    },
  ...
  },
  {
    ...
    defaultValue: '8%',
    source: {
      name: 'Assumption informed by Young & Varner',
      url: '',
      year: 2024,
      isAssumption: true,
      notes: 'Cumulative cap. Young & Varner found ~0.3pp/year additional migration per 1pp tax increase, implying ~1.5% cumulative over 5 years for a moderate increase. 8% allows headroom for large increases.',
    },
  ...
  },
  {
    ...
    defaultValue: '15%',
    source: {
      name: 'Assumption informed by CBC millionaire data',
      url: 'https://cbcny.org/research/hidden-cost-new-yorks-shrinking-millionaire-share',
      year: 2024,
      isAssumption: true,
      notes: 'NY nearly doubled its millionaire count 2010-2022 even while losing national share. NYC agglomeration (finance, media, law) continues attracting high earners. 15% is moderate.',
    },
    description: 'Fraction of departing high earners replaced by new arrivals. NYC agglomeration effects ensure ongoing inflow even during net outflow periods.',
    unit: 'fraction',
  },
];
